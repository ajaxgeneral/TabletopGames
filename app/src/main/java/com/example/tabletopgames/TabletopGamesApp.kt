...
private fun MainScreenContainer(
    ...
    Surface( modifier = modifier,
        ...
        when(screenState.value){
            ...
            Screen.EditDndLogSheetScreen -> EditDndLogSheetScreen(viewModel)
            Screen.EditDNDentryScreen -> EditDNDentryScreen(viewModel)
            Screen.EditMtgLogSheetScreen -> EditMtgLogSheetScreen(viewModel)
            Screen.EditMTGentryScreen -> EditMTGentryScreen(viewModel)
            Screen.EditMonopLogSheetScreen -> EditMonopLogSheetScreen(viewModel)
            ...
            Screen.MtgEntryScreen -> MtgEntryScreen(viewModel)
        }
    }
}
